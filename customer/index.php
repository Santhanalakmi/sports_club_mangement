...
<head>
        <title>Sports Club Admin</title><meta charset="UTF-8" />
    ...
    <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="#">
				 <div class="control-group normal_text"> <h3>Players Login</h3></div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><button type="submit" name="login" class="btn btn-success" />Players Login</button></span>
                </div>
                <div class="g">
                    ...
                    <div class="controls">
                        ...
                        <div class="controls">
                            ...
                            <option selected="true" disabled="disabled">Select Service</option>
                                ...
                                <option value="Sauna">Training and Coaching</option>
                                <option value="Cardio">Sports Leagues and Tournaments</option>
                            </select>
                            </div>
                        </div>
