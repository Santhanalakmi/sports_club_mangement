...
<div id="header">
  <h1><a href="dashboard.html">Sport Club Admin</a></h1>
</div>
<!--close-Header-part--> 
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              <label for="normal" class="control-label">Training Period </label>
              <div class="controls">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness Classes <small>-$50 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Training and Coaching <small>-$120  per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Sports Leagues and Tournaments<small>-$300 per month</small></label>
              </div>
            </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Santhanalaskhmi</a> </div>
</div>
